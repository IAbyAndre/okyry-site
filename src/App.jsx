...
function App() {
    ...
    return (
        <div className="min-h-screen bg-neutral-50 pb-20">
            {/* Header */}
            <header className="bg-white border-b border-neutral-100 py-6 mb-12 sticky top-0 z-10 backdrop-blur-md bg-white/80">
                <div className="container mx-auto px-6 max-w-4xl flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">
                            O
                        </div>
                        <span className="text-2xl font-bold tracking-tight text-neutral-900">Okyry</span>
                    </div>
                    <div className="hidden md:block text-sm font-medium text-neutral-400 uppercase tracking-widest">
            ...
            <footer className="mt-20 py-10 bg-white border-t border-neutral-100">
                <div className="container mx-auto px-6 max-w-4xl flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-2 opacity-50">
                        ...
                        <span className="text-lg font-bold tracking-tight text-neutral-900">Okyry</span>
                    </div>
                    <div className="text-neutral-400 text-sm">
                        © 2024 Okyry Technologies. Todos los derechos reservados.
                    </div>
                </div>
            </footer>
        </div>
